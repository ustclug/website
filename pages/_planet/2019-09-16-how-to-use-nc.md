...
![img](https://static.beta.ustclug.org/planet/explorer-1024x510.png)在 Windows 资源管理器中打开命令提示符或 PowerShell
...
![img](https://static.beta.ustclug.org/planet/cmdncat-1024x596.png)成功运行 `ncat`
...
![img](https://static.beta.ustclug.org/planet/nc-1024x596.png)Success!
